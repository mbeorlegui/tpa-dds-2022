...
public class Runner {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Ubicacion de Organizacion 0: " + ReportGenerator.getOrganizaciones().get(0).getUbicacion().getCalle());
    // System.out.println("Organizacion 0 en sector territorial: " + ReportGenerator.getSectorTerritorial(sectorTerritorial.getId()).getOrganizaciones().get(0).getRazonSocial());
