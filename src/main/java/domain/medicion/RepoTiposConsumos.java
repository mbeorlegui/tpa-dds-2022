...
public class RepoTiposConsumos {
  ...
  public boolean existeTipo(String nombre) {
    return
        this.getTiposConsumos()
            .stream()
            .anyMatch(unConsumo -> unConsumo.toString().equals(nombre));
  }

  public void actualizarTiposDeConsumoDB() {
    TipoConsumo gasNatural = new TipoConsumo(Actividad.COMBUSTION_FIJA,
        Alcance.EMISION_DIRECTA, Unidad.M3,
        new FactorDeEmision(0.2, UnidadEquivalenteCarbono.GRAMO),
        "GAS_NATURAL");
    TipoConsumo dieselGasoil = new TipoConsumo(Actividad.COMBUSTION_FIJA,
        Alcance.EMISION_DIRECTA, Unidad.LT,
        new FactorDeEmision(2.5, UnidadEquivalenteCarbono.GRAMO),
        "DIESEL_GASOIL");
    TipoConsumo nafta = new TipoConsumo(Actividad.COMBUSTION_FIJA,
        Alcance.EMISION_DIRECTA, Unidad.LT,
        new FactorDeEmision(2.3, UnidadEquivalenteCarbono.GRAMO),
        "NAFTA");
    TipoConsumo carbon = new TipoConsumo(Actividad.COMBUSTION_FIJA,
        Alcance.EMISION_DIRECTA, Unidad.KG,
        new FactorDeEmision(1.6, UnidadEquivalenteCarbono.GRAMO),
        "CARBON");
    TipoConsumo ccGasoil = new TipoConsumo(Actividad.COMBUSTION_MOVIL,
        Alcance.EMISION_DIRECTA, Unidad.LT,
        new FactorDeEmision(2.7, UnidadEquivalenteCarbono.GRAMO),
        "CC_GASOIL");
    TipoConsumo ccNafta = new TipoConsumo(Actividad.COMBUSTION_MOVIL,
        Alcance.EMISION_DIRECTA, Unidad.LT,
        new FactorDeEmision(2.4, UnidadEquivalenteCarbono.GRAMO),
        "CC_NAFTA");
    TipoConsumo electricidad = new TipoConsumo(Actividad.ELECTRICIDAD,
        Alcance.EMISION_INDIRECTA, Unidad.KWH,
        new FactorDeEmision(0.4, UnidadEquivalenteCarbono.GRAMO),
        "ELECTRICIDAD");
    ...
    TipoConsumo distanciaMedia = new TipoConsumo(Actividad.LOGISTICA,
        Alcance.OTRAS_EMISIONES, Unidad.KM,
        new FactorDeEmision(1.0, UnidadEquivalenteCarbono.GRAMO),
